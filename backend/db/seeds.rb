...
video8 = Video.create({video_url: 'https://www.youtube.com/watch?v=G8mBQsWJlFQ', name: "Demon Slayer | Zenitsu Thunder Clap [60 FPS]", thumbnail: 'https://www.placecage.com/c/200/300', description: 'eigth seed', url_id: 'something'})
